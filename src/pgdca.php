...
/**
 * Post Graduate Diploma in Computer Applications (PGDCA) Program Page
 * Centre for Computer Science and Applications (CCSA), Dibrugarh University
 */

$pageTitle = 'Post Graduate Diploma in Computer Applications (PGDCA) - CCSA';
$currentPage = 'programs';
include 'templates/header.php';
?>

<section class="py-12 sm:py-16 px-4 bg-slate-50 min-h-screen relative overflow-hidden">
    <!-- 🎓 Diploma & Computing Doodle Background Pattern -->
    <div class="absolute inset-0 pointer-events-none opacity-[0.06] select-none">
        <svg class="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <pattern id="doodle-pgdca" width="260" height="260" patternUnits="userSpaceOnUse" patternTransform="rotate(-1)">
                    ...
                    <!-- Fillers -->
                    <text x="68" y="28" font-family="'Courier New',monospace" font-size="12" font-weight="900" fill="#1a365d">PGDCA</text>
            ...
            <rect width="100%" height="100%" fill="url(#doodle-pgdca)"/>
        </svg>
    </div>
    ...
    <div class="container mx-auto max-w-6xl relative z-10">
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between gap-3 mb-3 flex-wrap">
                    <div class="flex items-center gap-3 flex-wrap">
                        <span class="bg-[#fbbf24] text-slate-900 text-xs font-extrabold px-3.5 py-1 rounded-full uppercase tracking-wider">Postgraduate Diploma</span>
                        <span class="bg-white/20 backdrop-blur-md text-white text-xs font-semibold px-3 py-1 rounded-full">1 Year &bull; 2 Semesters</span>
                    </div>
                ...
                <p class="text-blue-100 text-xs sm:text-base max-w-3xl leading-relaxed">
                    An industry-oriented intensive diploma programme designed to empower graduates across all disciplines with practical computing, application development, and IT management capabilities.
                </p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mb-8">
            <div class="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/80 shadow-sm text-center">
                ...
                <span class="text-lg sm:text-xl font-extrabold text-[#1a365d]">1 Year</span>
                <span class="text-[11px] text-slate-500 block">2 Semesters</span>
            </div>
            <div class="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/80 shadow-sm text-center">
                <span class="text-xs font-bold uppercase tracking-wider text-slate-500 block mb-1">Intake Capacity</span>
                <span class="text-lg sm:text-xl font-extrabold text-[#1a365d]">120 Seats</span>
                <span class="text-[11px] text-slate-500 block">40 Each Shift</span>
            </div>
            <div class="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/80 shadow-sm text-center">
                <span class="text-xs font-bold uppercase tracking-wider text-slate-500 block mb-1">Admission Basis</span>
                <span class="text-lg sm:text-xl font-extrabold text-[#1a365d]">Merit Basis</span>
                <span class="text-[11px] text-slate-500 block">Graduation Marks</span>
            </div>
            <div class="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/80 shadow-sm text-center">
                ...
                <span class="text-[11px] text-slate-500 block">UGC Recognized</span>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div class="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-slate-200/90 shadow-sm flex flex-col justify-between">
                <div>
                    ...
                    <p class="text-slate-700 text-sm sm:text-[15px] leading-relaxed mb-4">
                        The Post Graduate Diploma in Computer Applications (PGDCA) is a One (01) Year Diploma Program comprising Two (02) Semesters. Selection procedure for the PGDCA program is conducted on a <strong class="text-slate-900 font-bold">Merit Basis</strong>.
                    </p>
                    <p class="text-slate-700 text-sm sm:text-[15px] leading-relaxed">
                        PGDCA provides an accelerated pathway for graduates to master modern programming languages, database architectures, office publishing workflows, and web development, opening doors to careers in administrative computing, IT support, software testing, and digital media.
                    </p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-slate-200/90 shadow-sm flex flex-col justify-between">
                <div>
                    ...
                    <p class="text-slate-700 text-sm sm:text-[15px] leading-relaxed mb-4">
                        Graduates in any discipline recognized by Dibrugarh University with a minimum of <strong class="text-slate-900 font-bold">40% aggregate marks</strong>.
                    </p>
                    <div class="bg-slate-50 p-3.5 rounded-xl border border-slate-200/70 mb-3 text-xs sm:text-sm text-slate-700 leading-relaxed space-y-1.5">
                        <p><span class="font-bold text-[#1a365d]">&bull; Shift System:</span> Offered across morning/afternoon shifts with 40 seats allocated per shift.</p>
                        <p><span class="font-bold text-[#1a365d]">&bull; Category Relaxation:</span> Relaxation of 5% in aggregate marks is provided to candidates belonging to reserved categories.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-slate-200/90 shadow-sm flex flex-col justify-between">
                <div>
                    ...
                    <p class="text-slate-700 text-sm sm:text-[15px] leading-relaxed mb-4">
                        The PGDCA curriculum combines hands-on application training with core computer systems:
                    </p>
                    <div class="grid grid-cols-2 gap-2.5 mb-6 text-xs sm:text-sm text-slate-700 font-medium">
                        <div class="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200/60">
                            <i class="fas fa-check text-emerald-600 text-xs"></i> C Programming
                        </div>
                        <div class="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200/60">
                            <i class="fas fa-check text-emerald-600 text-xs"></i> Desktop Publishing (DTP)
                        </div>
                        <div class="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200/60">
                            <i class="fas fa-check text-emerald-600 text-xs"></i> Relational DBMS
                        </div>
                        <div class="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200/60">
                            <i class="fas fa-check text-emerald-600 text-xs"></i> Web Development
                        </div>
                        <div class="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200/60">
                            <i class="fas fa-check text-emerald-600 text-xs"></i> Computer Networks
                        </div>
                        <div class="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200/60">
                            <i class="fas fa-check text-emerald-600 text-xs"></i> Mobile Technologies
                        </div>
                    </div>
                </div>

                <a href="downloads/PGDCASyllabus.pdf" download="PGDCASyllabus.pdf"
                        ...
                        <table class="w-full text-left text-xs sm:text-sm">
                            ...
                            <tbody class="divide-y divide-slate-100 text-slate-700">
                                <tr class="hover:bg-slate-50">
                                    <td class="px-4 py-3.5">1<sup>st</sup> Semester</td>
                                    <td class="px-4 py-3.5 font-bold text-slate-900 text-right">Rs. 23,658</td>
                                </tr>
                                <tr class="hover:bg-slate-50">
                                    <td class="px-4 py-3.5">2<sup>nd</sup> Semester</td>
                                    <td class="px-4 py-3.5 font-bold text-slate-900 text-right">Rs. 23,658</td>
                                </tr>
                            </tbody>
                        </table>
