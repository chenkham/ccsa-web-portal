...
/**
 * Master of Computer Applications (MCA) Program Page
 * Centre for Computer Science and Applications (CCSA), Dibrugarh University
 */

$pageTitle = 'Master of Computer Applications (MCA) - CCSA';
...
<section class="py-12 sm:py-16 px-4 bg-slate-50 min-h-screen relative overflow-hidden">
    ...
    <div class="absolute inset-0 pointer-events-none opacity-[0.06] select-none">
        <svg class="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <pattern id="doodle-pg" width="260" height="260" patternUnits="userSpaceOnUse" patternTransform="rotate(-1)">
                    ...
                    <!-- Fillers -->
                    <text x="68" y="28" font-family="'Courier New',monospace" font-size="13" font-weight="900" fill="#1a365d">MCA</text>
            ...
            <rect width="100%" height="100%" fill="url(#doodle-pg)"/>
        </svg>
    </div>
    ...
    <div class="container mx-auto max-w-6xl relative z-10">
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between gap-3 mb-3 flex-wrap">
                    <div class="flex items-center gap-3 flex-wrap">
                        <span class="bg-[#fbbf24] text-slate-900 text-xs font-extrabold px-3.5 py-1 rounded-full uppercase tracking-wider">Postgraduate Degree</span>
                        <span class="bg-white/20 backdrop-blur-md text-white text-xs font-semibold px-3 py-1 rounded-full">2 Years &bull; 4 Semesters</span>
                    </div>
                ...
                <p class="text-blue-100 text-xs sm:text-base max-w-3xl leading-relaxed">
                    An advanced professional postgraduate programme designed for in-depth mastery of software architecture, intelligent systems, enterprise computing, and distributed architectures.
                </p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mb-8">
            <div class="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/80 shadow-sm text-center">
                ...
                <span class="text-lg sm:text-xl font-extrabold text-[#1a365d]">2 Years</span>
                <span class="text-[11px] text-slate-500 block">4 Semesters</span>
            </div>
            <div class="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/80 shadow-sm text-center">
                <span class="text-xs font-bold uppercase tracking-wider text-slate-500 block mb-1">Intake Capacity</span>
                <span class="text-lg sm:text-xl font-extrabold text-[#1a365d]">30 Seats</span>
                <span class="text-[11px] text-slate-500 block">+3 Endowments</span>
            </div>
            <div class="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/80 shadow-sm text-center">
                <span class="text-xs font-bold uppercase tracking-wider text-slate-500 block mb-1">Admission Basis</span>
                <span class="text-lg sm:text-xl font-extrabold text-[#1a365d]">Entrance Test</span>
                <span class="text-[11px] text-slate-500 block">DUAT Examination</span>
            </div>
            <div class="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/80 shadow-sm text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div class="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-slate-200/90 shadow-sm flex flex-col justify-between">
                <div>
                    ...
                    <p class="text-slate-700 text-sm sm:text-[15px] leading-relaxed mb-4">
                        The Master of Computer Applications (MCA) is a Two (02) Year Postgraduate Degree Program structured across Four (04) Semesters. Selection procedure for the MCA program is conducted through an official <strong class="text-slate-900 font-bold">Entrance Test (DUAT)</strong>.
                    </p>
                    <p class="text-slate-700 text-sm sm:text-[15px] leading-relaxed">
                        An MCA degree provides rigorous advanced training in cutting-edge computer science, equipping students with the deep theoretical and architectural skills required to lead in IT consultancy, research laboratories, enterprise software engineering, cloud infrastructures, and high-impact technology firms.
                    </p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-slate-200/90 shadow-sm flex flex-col justify-between">
                <div>
                    ...
                    <p class="text-slate-700 text-sm sm:text-[15px] leading-relaxed mb-4">
                        Graduates in any discipline from a recognized University / Institution with a minimum aggregate of <strong class="text-slate-900 font-bold">50% marks</strong> and having passed Mathematics as one of the subjects at the 10+2 level.
                    </p>
                    <div class="bg-slate-50 p-3.5 rounded-xl border border-slate-200/70 mb-3 text-xs sm:text-sm text-slate-700 leading-relaxed space-y-1.5">
                        <p><span class="font-bold text-[#1a365d]">&bull; Entrance Exam:</span> Candidates must qualify in the Dibrugarh University Admission Test (DUAT).</p>
                        <p><span class="font-bold text-[#1a365d]">&bull; Category Relaxation:</span> Relaxation of 5% marks in aggregate is granted to candidates belonging to reserved categories.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-slate-200/90 shadow-sm flex flex-col justify-between">
                <div>
                    <h2 class="text-lg sm:text-xl font-bold font-display uppercase tracking-wide text-[#1a365d] mb-4 pb-2 border-b border-slate-100 flex items-center gap-2">
                        <i class="fas fa-book-open text-[#fbbf24]"></i> Curriculum &amp; Specializations
                    </h2>
                    <p class="text-slate-700 text-sm sm:text-[15px] leading-relaxed mb-4">
                        The MCA curriculum blends core foundations with industry-ready electives and a mandatory major project internship:
                    </p>
                    <div class="grid grid-cols-2 gap-2.5 mb-6 text-xs sm:text-sm text-slate-700 font-medium">
                        <div class="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200/60">
                            <i class="fas fa-check text-emerald-600 text-xs"></i> Advanced Java, Python &amp; C#
                        </div>
                        <div class="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200/60">
                            <i class="fas fa-check text-emerald-600 text-xs"></i> Algorithm Design &amp; Optimization
                        </div>
                        <div class="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200/60">
                            <i class="fas fa-check text-emerald-600 text-xs"></i> Enterprise DBMS &amp; Cloud DBs
                        </div>
                        <div class="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200/60">
                            <i class="fas fa-check text-emerald-600 text-xs"></i> Systems &amp; Kernel Architecture
                        </div>
                        <div class="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200/60">
                            <i class="fas fa-check text-emerald-600 text-xs"></i> Cloud Computing &amp; Big Data
                        </div>
                        <div class="flex items-center gap-2 p-2 bg-slate-50 rounded-lg border border-slate-200/60">
                            <i class="fas fa-check text-emerald-600 text-xs"></i> Major Industry Project / Internship
                        </div>
                    </div>
                </div>

                <a href="downloads/MCA.pdf" download="MCA_Syllabus.pdf"
            ...
            <div class="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-slate-200/90 shadow-sm flex flex-col justify-between">
                        ...
                        <table class="w-full text-left text-xs sm:text-sm">
                            ...
                            <tbody class="divide-y divide-slate-100 text-slate-700">
                                <tr class="hover:bg-slate-50">
                                    <td class="px-4 py-3">1<sup>st</sup> Semester</td>
                                    <td class="px-4 py-3 font-bold text-slate-900 text-right">Rs. 28,658</td>
                                </tr>
                                <tr class="hover:bg-slate-50">
                                    <td class="px-4 py-3">2<sup>nd</sup> Semester</td>
                                    <td class="px-4 py-3 font-bold text-slate-900 text-right">Rs. 25,000</td>
                                </tr>
                                <tr class="hover:bg-slate-50">
                                    <td class="px-4 py-3">3<sup>rd</sup> Semester</td>
                                    <td class="px-4 py-3 font-bold text-slate-900 text-right">Rs. 28,380</td>
                                </tr>
                                <tr class="hover:bg-slate-50">
                                    <td class="px-4 py-3">4<sup>th</sup> Semester</td>
                                    <td class="px-4 py-3 font-bold text-slate-900 text-right">Rs. 15,000</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <a href="https://drive.google.com/uc?export=download&id=1h0HE1eFbI4UhzJ_ctUjOrPS93QddpkZ7" download="Fee_Structure_MCA.pdf"
